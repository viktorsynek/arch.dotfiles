...
- SDDM: Catppuccin Frappé Mauve
- Terminal: Powerlevel10k
- Tmux: Catppuccin Frappé

#### Packages
A full list of installed packages can be found @ [packages.txt](https://github.com/viktorsynek/arch.dotfiles/blob/main/packages.txt).
